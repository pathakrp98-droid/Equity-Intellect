...
- [x] **Step 1: Write hosting behavior tests**
...
- [x] **Step 2: Run the hosting test red**
...
- [x] **Step 3: Implement safe static serving**
...
- [x] **Step 4: Put frontend output inside the API artifact**
...
- [x] **Step 5: Add no-billing configuration and documentation**
